...
const Footer = () => {
    return (
        <section className='w-screen h-dvh px-6 mt-10'>
            <p className='text-[.7rem] text-[#eae5dd] choose-subtitle mt-10'>Interested in an amazing adventure?<br />Reserve your stay at Everdia</p>
            <div>
                <MarqueeText />
            </div>

            <div className='flex justify-between items-center text-2xl mt-14'>
                <h3 className='text-[#b1a696]'>Everdia offers luxury eco-resorts<br />
                    nestled in serene natural landscapes.<br />
                    Experience nature with ultimate comfort.<br /><br />
                    If you would like to book your stay—<a href="#" className='text-[#f4efe7] hover:text-[#c4c1b9] underline'> contact us.</a>
                </h3>
                ...
                <div className='flex flex-col justify-center items-end'>
                    ...
                    <a href="#welcome" className='text-[#f2ede5] text-2xl'>Why Everdia</a>
